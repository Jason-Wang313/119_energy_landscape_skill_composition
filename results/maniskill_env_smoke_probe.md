...
Asset install hint: `python -m mani_skill.utils.download_asset oakink-v2 -y; python -m mani_skill.utils.download_asset ycb -y`
Missing asset IDs: `['oakink-v2', 'ycb']`

## Environment Records

| Env ID | Primary for | Support for | Missing assets | Made | Reset | Error |
|---|---|---|---|---|---|---|
| `InsertFlower-v1` | `none` | `cable_route_insert` | `oakink-v2` | `False` | `False` | EOF when reading a line |
| `OpenCabinetDoor-v1` | `door_open_navigation` | `none` | `none` | `True` | `True` |  |
| `OpenCabinetDrawer-v1` | `drawer_to_pick_transfer` | `none` | `none` | `True` | `True` |  |
| `PegInsertionSide-v1` | `peg_place_regrasp` | `none` | `none` | `True` | `True` |  |
| `PickCube-v1` | `none` | `drawer_to_pick_transfer` | `none` | `True` | `True` |  |
| `PickSingleYCB-v1` | `none` | `drawer_to_pick_transfer` | `ycb` | `False` | `False` | EOF when reading a line |
| `PullCubeTool-v1` | `cable_route_insert` | `none` | `none` | `True` | `True` |  |
...
- `pass` `asset_failures_reported`: asset_related_failures=['InsertFlower-v1', 'PickSingleYCB-v1'], missing_asset_ids=['oakink-v2', 'ycb']
