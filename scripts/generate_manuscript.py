...
def make_manuscript(summary):
    ...
    a(
        "The broader question is how a robot represents the physical consequences of a skill transition, detects when that representation is not enough, and adapts future planning from the outcome. This is deliberately a small, concrete instance of adaptive physical world/action models for embodied agents: the model is local, and the prediction-action-update loop is the object of study."
    )
    a(
