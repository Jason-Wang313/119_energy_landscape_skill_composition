...
def make_manuscript(summary):
    ...
    a(
        "The broader question is how a robot represents the physical consequences of a skill transition, notices when that representation is incomplete, and adapts future planning from the outcome. This places the paper inside adaptive physical world/action models for embodied agents, but at a deliberately local scale: the model is not a whole robot simulator, and the prediction-action-update loop is the object of study."
    )
    a(
