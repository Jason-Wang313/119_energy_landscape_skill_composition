...
def main() -> int:
    ...
    add_check(
        ...
        "strict rollout validation rejects placeholder/diagnostic/staged/backup/non-MP4 video paths, duplicate rows/videos, stale task configs, and manifest method-hash mismatches",
    )
