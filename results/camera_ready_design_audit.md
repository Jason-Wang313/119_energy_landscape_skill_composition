...
Pages: `13`.
Render DPI: `70`.
Foreground density range: `0.0826` to `0.1718`.
...
- `pass` `page_count_compact`: pages=13, expected=8-18
- `pass` `rendered_page_count_matches_pdf`: rendered=13, pages=13
...
- `pass` `sparse_pages_bounded`: sparse_pages=[]
