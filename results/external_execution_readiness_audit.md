...
- `pass` `maniskill_env_smoke_probe_not_evidence`: strict_env_smoke_ready=False, primary_reset_missing=['OpenCabinetDoor-v1', 'OpenCabinetDrawer-v1']
...
- `pass` `external_operator_handoff_bundle_hash_manifest`: included_file_count=232, category_counts={'baseline_spec': 12, 'config_template': 4, 'generated_non_evidence_report': 66, 'operator_command_source': 27, 'operator_facing_input': 50, 'prepared_config_input': 4, 'reference_adapter': 60, 'runner_backend_template': 5, 'task_card': 4}
