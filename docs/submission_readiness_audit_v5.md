...
- External fidelity acceptance draft: `external_validation/fidelity_acceptance_draft.md` and `results/external_fidelity_acceptance_draft_audit.md` exist, pass, prefill tracked ManiSkill route anchors and fidelity metadata fields, and remain draft-only/non-evidence with `acceptance_ready=false` and unaccepted gates.
