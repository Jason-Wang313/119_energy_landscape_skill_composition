...
- `pass` `abstract_exists`: words=247
- `pass` `abstract_length_conference_reasonable`: words=247
- `pass` `required_sections_present`: positions=[2830, 6798, 10349, 12290, 13134, 14684, 25095, 30057]
- `pass` `required_sections_in_order`: positions=[2830, 6798, 10349, 12290, 13134, 14684, 25095, 30057]
...
- `pass` `core_frame_term_deliberately local form`: deliberately local form
...
- `pass` `core_frame_term_choose another transition`: choose another transition
...
- `pass` `world_action_framing_not_overdone`: count=5
