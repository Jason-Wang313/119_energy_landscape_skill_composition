...
- `pass` `gate_order_preserves_preflight_before_collection_and_evidence`: positions={'audit_external_fidelity_acceptance.py': 403, 'audit_external_backend_contract.py': 623, 'audit_maniskill_reference_collection_preflight.py': 725, 'audit_maniskill_render_video_preflight.py': 1112, 'real_collection_runner.py --backend-module <module_or_path>': 1928, 'build_external_manifest.py --write --check-video-paths': 2178, 'validate_external_rollouts.py --write-results --check-video-paths --strict': 2421, 'audit_external_evidence.py --strict': 2571}
