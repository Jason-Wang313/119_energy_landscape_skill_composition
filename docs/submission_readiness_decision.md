...
- atomic official JSONL promotion stages selected-batch rows and replaces official logs only after the batch succeeds, preserving prior official logs on backend failure.
