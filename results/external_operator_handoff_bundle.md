...
- `baseline_spec`: `12`
- `config_template`: `4`
- `generated_non_evidence_report`: `74`
- `operator_command_source`: `31`
- `operator_facing_input`: `52`
...
- `README.md` (operator_facing_input, 16581 bytes, sha256 `D024DB6378E9493B360CE0FDACE19710FC37DE8C8B95BD886F344036500E6599`)
- `docs/haonan_yilun_outreach_package.md` (operator_facing_input, 10551 bytes, sha256 `F6EA44127E62E9E1E157603725DCC9BF17415023D99B1C501599B0498A4E56CF`)
...
- `docs/reproducibility_checklist.md` (operator_facing_input, 15534 bytes, sha256 `A597A3AA983731D9261A6617214842A2F0256DD7731A763D71ABAA0AB2A0DECB`)
- `docs/submission_readiness_decision.md` (operator_facing_input, 7486 bytes, sha256 `3489CB5FF1C8F2C5A48EC3226828F68F71EFA1279A578F3F7EA0AA44C1C2F4A9`)
- `external_validation/README.md` (operator_facing_input, 30696 bytes, sha256 `B9D758842D8D31E02CFFEB9167C3C13A7BCFF96E71C16B830EF3D5EBC712BD54`)
...
- `external_validation/collection_runbook.md` (operator_facing_input, 4092 bytes, sha256 `238BAEC4A9C95DBD84EA66AFB7AE4013E3A7396685F08380A055DD75A60064D6`)
...
- `external_validation/fidelity_acceptance_draft.json` (operator_facing_input, 24987 bytes, sha256 `B5537CE7248AB4A7B6CF62727434FA1A7994B621EFE6396F5E50D3E553CC1735`)
- `external_validation/fidelity_acceptance_draft.md` (operator_facing_input, 5413 bytes, sha256 `0919BFCDCAEDA9EE18B88FEAF071CF8A92658E705C19AFEBF9A76E2FF5E46C3B`)
...
- `external_validation/fidelity_provenance_packet.json` (operator_facing_input, 13652 bytes, sha256 `0237C201F3B03B032F09B07610D6871AFF8A55167408B61ED84F35FBB1F739B3`)
- `external_validation/fidelity_provenance_packet.md` (operator_facing_input, 2877 bytes, sha256 `6AD878BBFFF1F91CC6A7783A30E5F62AC051C75B0A8DC6AE5A46231636FE516E`)
- `external_validation/fidelity_provenance_work_orders.csv` (operator_facing_input, 6680 bytes, sha256 `2E6D49871808749857C4250AB85B017718E45D5EC8BB48B1B59092DF5C812239`)
...
- `external_validation/method_implementation_packet.json` (operator_facing_input, 37741 bytes, sha256 `0E1249BB79ED66190581C0A6291AF7AE846C25C6D5413C2B00C10A253DF1EE66`)
- `external_validation/method_implementation_packet.md` (operator_facing_input, 18703 bytes, sha256 `8CF68740AB8A1D230D1AAA6FDC24EF1E3C845D1C0328FB86D8DBA1E67B30DCD2`)
...
- `external_validation/platform_onboarding_packet.json` (operator_facing_input, 12470 bytes, sha256 `FE45C1B96B4D111C477CD829CA4F81660FAC5ADD17E122E7B27E4369F0EFB73B`)
- `external_validation/platform_onboarding_packet.md` (operator_facing_input, 9597 bytes, sha256 `9CDDF99391436AB7D176194CAD710EBC012CB792D0B4625DF036C51EADC837CD`)
...
- `external_validation/runner/README.md` (operator_facing_input, 3716 bytes, sha256 `67A570BCB3377263F89123A8DE66346CDF31C518279563333792D681CD31212D`)
...
- `external_validation/runner/maniskill_reference_backend.py` (operator_facing_input, 19601 bytes, sha256 `DB1A400FEBDD2C2C6AD5D0390742328007DD1C72348CC273FB87037C52B6F627`)
...
- `results/external_acquisition_packet.json` (generated_non_evidence_report, 33273 bytes, sha256 `E51389120B56D6102F7B50EFDBD270AEC68522BB8D051F9AEDA13FAB4D018DE1`)
- `results/external_acquisition_packet.md` (generated_non_evidence_report, 22000 bytes, sha256 `B9B16E093E4F664E8F4CC23E5B4EC044997301DF29D9F7230F8FB287CE5BC47E`)
...
- `results/external_collection_plan.json` (generated_non_evidence_report, 145981 bytes, sha256 `7ABF6969753B93808A408A19713AC127FDFA8F82467CBEB5F7B79F2AD2F11A29`)
- `results/external_collection_plan.md` (generated_non_evidence_report, 4437 bytes, sha256 `300240030DCD06E4BF4DBB44D221E1EB413A914575C11727A4334C0CA03F7F5D`)
...
- `results/external_execution_readiness_audit.json` (generated_non_evidence_report, 30564 bytes, sha256 `DC3A04699064F691DDC742D27D0BC4A038E0F3E56AEB2830A959E2F0CBE44B99`)
- `results/external_execution_readiness_audit.md` (generated_non_evidence_report, 23429 bytes, sha256 `36E81698CC27D0738966EE9CFC6ED9900A759D65362AD6588F883FFCBDE3D7C9`)
...
- `results/external_fidelity_acceptance_draft_audit.json` (generated_non_evidence_report, 5441 bytes, sha256 `158DD224489AFFAC38A2597CDA68E3F27165EEB86E4873924EECF4055EB9D9D0`)
- `results/external_fidelity_acceptance_draft_audit.md` (generated_non_evidence_report, 4313 bytes, sha256 `3B970832FB673E9A22E3062050BF76EA332F9C7F4FC6449971215648D9F77277`)
- `results/external_fidelity_provenance_audit.json` (generated_non_evidence_report, 2996 bytes, sha256 `38088589317DCFE4E64312D23326C0138D241E24DB2369AA9E81E103FB0C4A55`)
- `results/external_fidelity_provenance_audit.md` (generated_non_evidence_report, 2181 bytes, sha256 `3177E678AE10559911411D816D161FD7159B2C52000A8EE64E91078E36E49448`)
- `results/external_method_implementation_audit.json` (generated_non_evidence_report, 3203 bytes, sha256 `FD6362F78BF0CFBFC4714168061B970F0115CF4D958C178BBF68EAAB5C359456`)
- `results/external_method_implementation_audit.md` (generated_non_evidence_report, 2406 bytes, sha256 `59DA0FC932E329A9D91214406C6E8A0FEB851CF2C7DDD8165B7E82D570B7025B`)
- `results/external_operator_packet.json` (generated_non_evidence_report, 30066 bytes, sha256 `388FB99849E7FE77F83813B03ED7FBBA0EFD7EAD164DDD83425A5927EE64E306`)
- `results/external_operator_packet.md` (generated_non_evidence_report, 10108 bytes, sha256 `BEC388312A45DF02D75449A54DA08C8DB83ABA8546BB6FE10303E025A51954CC`)
...
- `results/external_platform_onboarding_audit.json` (generated_non_evidence_report, 7974 bytes, sha256 `1CAC4AB22BCCCB84C165AB0552706EEB384CC66CC3173D923CD46A398E6FA42B`)
- `results/external_platform_onboarding_audit.md` (generated_non_evidence_report, 6223 bytes, sha256 `3420BD6F90C15E486CE03922E94B06B70C94C897A0B379C88B6363647ADAB623`)
- `results/external_platform_probe.json` (generated_non_evidence_report, 11146 bytes, sha256 `E099F040957A92CD8462E6D336FACBEB79CAD34B62C991E457DF55B744F24584`)
- `results/external_platform_probe.md` (generated_non_evidence_report, 2287 bytes, sha256 `AC233C78B2644ACCF0DF461CE250E5FFEE63E0AFFAC59F6CD687E5BF5137D719`)
...
- `results/maniskill_backend_readiness_audit.json` (generated_non_evidence_report, 4568 bytes, sha256 `2FB19F1C406F918DFC2FD7DDC1A1E8F15F5E78A75FFE824B863800B53CFCB668`)
- `results/maniskill_backend_readiness_audit.md` (generated_non_evidence_report, 2885 bytes, sha256 `D76883C75BDD542D449C48F0B006E4B0BCCD5F8013473B6366C576EDB1CDD01D`)
- `results/maniskill_env_smoke_probe.json` (generated_non_evidence_report, 13635 bytes, sha256 `9A201839B28D2D64181AF1747A9F49808442C62B4C586684CC09C37544F34698`)
...
- `results/maniskill_fidelity_metadata_probe.json` (generated_non_evidence_report, 34327 bytes, sha256 `6A4A65C23C841B0C56CA137AB761BB19E0CC43103098C8CDDFA1440C3659E164`)
...
- `results/maniskill_pilot_runtime_liveness_audit.json` (generated_non_evidence_report, 3897 bytes, sha256 `A9E8E9DD8CE7F3651D4C3A7338056B9C924FE0BD6F52DE9F1724B20437C70EE2`)
- `results/maniskill_pilot_runtime_liveness_audit.md` (generated_non_evidence_report, 2511 bytes, sha256 `ECA4517F8CD73B9B6BAD3FA1095CC361798C26BC5912283C541B9AAD7D35FFDD`)
...
- `scripts/audit_maniskill_backend_readiness.py` (operator_command_source, 8884 bytes, sha256 `596DD2BE7A1952C6BA315CB303E4AB08105E9FEF9F81901763B874C2BD180F48`)
- `scripts/audit_maniskill_pilot_runtime_liveness.py` (operator_command_source, 16669 bytes, sha256 `1E19B6D45CF3BB2A9A5A0DD91CF293F84A18057094A593ED66B72E4A467E624B`)
...
- `scripts/build_external_acquisition_packet.py` (operator_command_source, 55148 bytes, sha256 `6894EC6A3445B5E2FD2556EC2F50012A54B52BC843B19B081AC3E0453AF928CD`)
...
- `scripts/build_external_fidelity_acceptance_draft.py` (operator_command_source, 39220 bytes, sha256 `B8E09558BDEE321B141BC85BCE48FA04560254119B3862D335372BAAEBFBEA9F`)
- `scripts/build_external_fidelity_provenance_packet.py` (operator_command_source, 21473 bytes, sha256 `6B8748DDFFAE3ECA55291447F638D06A3468EC9EAAE59DE8C555D232929EB871`)
...
- `scripts/build_external_method_implementation_packet.py` (operator_command_source, 19526 bytes, sha256 `84FBA076C70EA097C5B223886D3A1DFB27D667F5068F2E8930EBCC885AF6EEA5`)
- `scripts/build_external_operator_handoff_bundle.py` (operator_command_source, 45609 bytes, sha256 `BD80583A5690179738934007B5DF722A05A4AD41B037EBDF7C9BA682A637D568`)
- `scripts/build_external_operator_packet.py` (operator_command_source, 24280 bytes, sha256 `9996772132EA473A84C8247113462092E7F71A5BCEFF08395A7C83361DD19F4C`)
...
- `scripts/build_external_platform_onboarding.py` (operator_command_source, 30878 bytes, sha256 `C4ED6FD67A2A473D274357433B61CE37CC6E50A0D6EB3E0EF8538192FCEF8360`)
...
- `scripts/validate_external_adapters.py` (operator_command_source, 22213 bytes, sha256 `8A8C66ADE8BBB17AB0DE28FE5F2B6DBD96C3836CB974ABE2D2F0E78309455E88`)
...
- `pass` `handoff_has_task_config_and_baseline_assets`: category_counts={'baseline_spec': 12, 'config_template': 4, 'generated_non_evidence_report': 74, 'operator_command_source': 31, 'operator_facing_input': 52, 'prepared_config_input': 4, 'reference_adapter': 60, 'runner_backend_template': 5, 'task_card': 4}
...
- `pass` `maniskill_pilot_runtime_liveness_included`: pilot_runtime_ready=False, runner_io_ready=True, render_video_ready=False, timed_out=False, diagnostic_fallbacks=1, failure_summary='runner wrote quarantined schema-valid row/video using diagnostic non-evidence video fallback; render-backed video remains unavailable'
...
- `pass` `file_hashes_are_recorded`: hashed_files=246
