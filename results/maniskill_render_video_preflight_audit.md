...
- `not_ready` `peg_place_regrasp` / `PegInsertionSide-v1`: made_env=None, reset_ok=None, render_ok=None, mp4_ok=None, error='render preflight exceeded 30 seconds after progress stage import_start', last_stage='import_start'
- `not_ready` `drawer_to_pick_transfer` / `OpenCabinetDrawer-v1`: made_env=None, reset_ok=None, render_ok=None, mp4_ok=None, error='render preflight exceeded 30 seconds after progress stage import_start', last_stage='import_start'
- `not_ready` `door_open_navigation` / `OpenCabinetDoor-v1`: made_env=True, reset_ok=True, render_ok=False, mp4_ok=False, error='render preflight exceeded 30 seconds after progress stage close_done', last_stage='close_done'
...
- `pass` `render_progress_markers_recorded`: last_stages=['import_start', 'import_start', 'close_done', 'close_done']
...
- `pass` `renderer_failure_class_recorded_when_not_ready`: classes=['render_timeout', 'vulkan_descriptor_pool_exhaustion']
- `pass` `operator_remediation_present_when_not_ready`: items=6
