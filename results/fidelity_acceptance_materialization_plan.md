...
- `pass` `postcollection_evidence_deferred_until_after_collection`: fidelity acceptance is a precollection platform/provenance gate; official rollout logs and manifest declaration remain postcollection strict gates
