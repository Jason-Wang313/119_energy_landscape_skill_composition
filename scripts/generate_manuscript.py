...
def make_manuscript(summary):
    ...
    a(
        ...
        "The current evidence supports a bounded claim: a local predictive world/action model at skill seams improves composition when basin, barrier, and descent quantities are estimable and their outcomes update future planning. This is not a full robot world model; external robot or high-fidelity validation remains necessary before deployment-level claims."
    )
    a(r"\end{abstract}")
