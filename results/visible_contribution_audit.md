...
- `pass` `operator_handoff_bundle_visible`: files=293, forbidden=[], start_state='DO_NOT_COLLECT_YET'
- `pass` `external_runbook_route_gates_visible`: validation_command_count=45, route_gates=True, gate_order=True
