...
try {
    ...
    Invoke-Step "Run external validation tooling checks" {
        ...
        Invoke-Native python scripts\self_test_external_fidelity_provenance_packet.py
        ...
        Invoke-Native python scripts\self_test_fidelity_acceptance_materializer.py
        ...
        Invoke-Native python scripts\self_test_external_method_implementation_packet.py
        Invoke-Native python scripts\materialize_external_method_configs.py
        Invoke-Native python scripts\self_test_external_method_config_materialization.py
        ...
        Invoke-Native python scripts\self_test_external_evidence_preflight.py
        ...
        Invoke-Native python scripts\self_test_external_rollout_evidence_packet.py
        ...
        Invoke-Native python scripts\self_test_external_precollection_freeze_receipt.py
        Invoke-Native python scripts\build_external_postcollection_evidence_seal.py
        Invoke-Native python scripts\self_test_external_postcollection_evidence_seal.py
        ...
        Invoke-Native python scripts\self_test_external_operator_release_bundle.py
        ...
        Invoke-Native python scripts\self_test_external_execution_readiness.py
    }
