...
def main() -> int:
    ...
    closure_brief = read_json(RESULTS / "external_evidence_closure_brief.json")
    closure_brief_self_test = read_json(RESULTS / "external_evidence_closure_brief_self_test.json")
    ...
    render_host_brief = read_json(RESULTS / "maniskill_render_host_qualification_brief_audit.json")
    ...
    method_config_materialization_self_test = read_json(RESULTS / "external_method_config_materialization_self_test.json")
    ...
    config_materialization_self_test = read_json(RESULTS / "external_config_materialization_self_test.json")
    ...
    closure_checks = {check.get("name"): check.get("passed") for check in closure_brief.get("checks", []) or []}
    closure_self_checks = {check.get("name"): check.get("passed") for check in closure_brief_self_test.get("checks", []) or []}
    add_check(
        checks,
        "external_evidence_closure_brief_visible",
        closure_brief.get("version") == "external_evidence_closure_brief_v1"
        ...
        and closure_brief.get("blocking_missing_requirements") == 4
        ...
        and "External evidence closure brief" in texts["README"]
        and "External evidence closure brief" in texts["final_audit"]
        and "External evidence closure brief" in texts["readiness_audit"]
        and "External evidence closure brief" in texts["reproducibility"]
        and "Minimum Proof Package" in texts["closure"]
        and "Chronological Command Spine" in texts["closure"]
        and "Do not pitch Haonan as responsible for supplying the missing proof" in texts["closure"],
        (
            f"blockers={closure_brief.get('blocking_missing_requirements')!r}, "
            f"items={len(closure_brief.get('closure_items', []) or [])}, "
            f"haonan_dependency={closure_brief.get('haonan_dependency')!r}"
        ),
    )
    add_check(
        checks,
        "external_evidence_closure_brief_self_test_visible",
        closure_brief_self_test.get("version") == "external_evidence_closure_brief_self_test_v1"
        and closure_brief_self_test.get("passed") is True
        and closure_brief_self_test.get("not_external_evidence") is True
        and closure_brief_self_test.get("strict_external_evidence_ready") is False
        ...
        and closure_self_checks.get("unmapped_fifth_blocker_rejected") is True
        and closure_self_checks.get("premature_manifest_rejected") is True
        and closure_self_checks.get("missing_linux_command_spine_rejected") is True
        and closure_self_checks.get("haonan_dependent_route_rejected") is True
        and closure_self_checks.get("missing_source_packet_rejected") is True
        and closure_self_checks.get("real_repository_closure_outputs_untouched") is True
        and (ROOT / "scripts" / "self_test_external_evidence_closure_brief.py").exists()
        and (RESULTS / "external_evidence_closure_brief_self_test.md").exists()
        and "External evidence closure brief self-test" in texts["README"]
        and "External evidence closure brief self-test" in texts["final_audit"]
        and "External evidence closure brief self-test" in texts["readiness_audit"]
        and "External evidence closure brief self-test" in texts["reproducibility"],
        (
            f"fixture_ready={closure_brief_self_test.get('temporary_fixture_ready')!r}, "
            f"unmapped_rejected={closure_brief_self_test.get('unmapped_blocker_rejected')!r}, "
            f"haonan_rejected={closure_brief_self_test.get('haonan_dependent_route_rejected')!r}"
        ),
    )
    ...
    render_host_source_urls = [
        str(source.get("url", ""))
        for source in render_host_brief.get("official_sources", []) or []
        if isinstance(source, dict)
    ]
    add_check(
        checks,
        "maniskill_render_host_qualification_brief_visible",
        render_host_brief.get("version") == "maniskill_render_host_qualification_brief_v1"
        ...
        and any("ErrorOutOfPoolMemory" in str(error) for error in render_host_brief.get("error_signatures", []) or [])
        ...
        and any("maniskill.readthedocs.io" in url for url in render_host_source_urls)
        and any("sapien.ucsd.edu" in url for url in render_host_source_urls)
        and any("registry.khronos.org" in url for url in render_host_source_urls)
        and (ROOT / "scripts" / "build_maniskill_render_host_qualification_brief.py").exists()
        and (ROOT / "docs" / "maniskill_render_host_qualification_brief.md").exists()
        and (ROOT / "external_validation" / "render_host_qualification_brief.md").exists()
        and (RESULTS / "maniskill_render_host_qualification_brief_audit.md").exists(),
        (
            f"host_state={render_host_brief.get('host_qualification_state')!r}, "
            f"collection_state={render_host_brief.get('collection_state')!r}, "
            f"sources={render_host_source_urls}"
        ),
    )
    ...
    add_check(
        ...
        config_materialization_self_test.get("version") == "external_config_materialization_self_test_v1"
        ...
        and (ROOT / "scripts" / "self_test_external_config_materialization.py").exists()
        and (RESULTS / "external_config_materialization_self_test.md").exists()
        and "External config materialization self-test" in texts["README"]
        and "External config materialization self-test" in texts["final_audit"]
        and "External config materialization self-test" in texts["reproducibility"]
        and "External config materialization self-test" in texts["outreach"],
        (
    ...
    precollection_manifest_self_checks = {
        check.get("name"): check.get("passed") for check in precollection_manifest_self_test.get("checks", []) or []
    }
    add_check(
        checks,
        "precollection_manifest_draft_self_test_visible",
        precollection_manifest_self_test.get("version") == "external_precollection_manifest_draft_self_test_v1"
        ...
        and precollection_manifest_self_checks.get("temporary_precollection_manifest_draft_ready_but_non_evidence") is True
        and precollection_manifest_self_checks.get("real_precollection_manifest_outputs_untouched") is True
        and (ROOT / "scripts" / "self_test_external_precollection_manifest_draft.py").exists()
        and (RESULTS / "external_precollection_manifest_draft_self_test.md").exists()
        and "External precollection manifest draft self-test" in texts["README"]
        and "External precollection manifest draft self-test" in texts["final_audit"]
        and "External precollection manifest draft self-test" in texts["reproducibility"],
        (
    ...
    add_check(
        ...
        method_config_materialization_self_test.get("version") == "external_method_config_materialization_self_test_v1"
        ...
        and (ROOT / "scripts" / "self_test_external_method_config_materialization.py").exists()
        and (RESULTS / "external_method_config_materialization_self_test.md").exists()
        and "External method config materialization self-test" in texts["README"]
        and "External method config materialization self-test" in texts["final_audit"]
        and "External method config materialization self-test" in texts["reproducibility"]
        and "External method config materialization self-test" in texts["outreach"],
        (
    ...
    add_check(
        ...
        "ledger_tracks_new_visible_claims",
        {
            ...
            "maniskill_render_host_qualification_brief_claim",
            ...
            "external_method_config_materialization_self_test_claim",
    ...
    required_terms_by_file = {
        "README": [
            ...
            "render host qualification brief",
