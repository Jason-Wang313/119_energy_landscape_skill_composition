...
Honest strongest claim: `Compose skills by compatible energy landscapes rather than sequencing policy modules.` is a plausible branch-structured mechanism for energy-based robot skill learning, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
