...
- The external collection runbook route-gate audit now checks 42 validation commands, the current ManiSkill route gates, and the actual high-fidelity collection command template before official collection or strict evidence gates.
