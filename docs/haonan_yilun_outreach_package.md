...
- Keep the independent validation protocol, `results/external_operator_packet.md`, and the ManiSkill fidelity metadata probe ready as follow-up artifacts, not as first-email clutter.
