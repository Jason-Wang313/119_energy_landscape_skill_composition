...
Novelty boundary: the paper is not "energy-based robot learning" broadly and not "skill sequencing with another score." The defensible contribution is checking and repairing energy-landscape compatibility at skill seams.
