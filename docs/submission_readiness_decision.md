...
- The generated external operator packet is a no-go handoff for independent validation: it lists the five pre-collection blockers, exact collection command, and post-collection strict gates without claiming evidence.
