...
\]
It then chooses among \textbf{accept}, \textbf{repair}, \textbf{probe}, \textbf{abstain}, or \textbf{fallback}. The contribution is a seam-level predictive interface in the world/action-modeling family, not a new low-level controller or universal manipulation policy.
