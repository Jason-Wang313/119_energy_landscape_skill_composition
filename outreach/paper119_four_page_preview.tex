...
Each run should use the same primitive skill library across baselines and log terminal samples, basin estimates, barrier scores, descent diagnostics, predicted risk, accepted/rejected seams, final outcomes, and videos.
...
The clean ask is not for a collaborator to validate the paper. The clean ask is:
