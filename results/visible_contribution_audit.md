...
- `pass` `strict_video_evidence_gate_visible`: strict rollout validation rejects placeholder/diagnostic/staged/backup/non-MP4 video paths, duplicate rows/videos, weak sample counts, stale task configs, and manifest method-hash mismatches
