...
def main() -> int:
    ...
    add_requirement(
        requirements,
        requirement="Single-command local reproducibility plus validator self-tests",
        ...
        blocker="" if reproducible_ok else "rebuild or validation self-test entry point is missing",
        submission_blocking=True,
    )
