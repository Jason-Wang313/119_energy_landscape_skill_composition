...
Render host qualification brief: `docs/maniskill_render_host_qualification_brief.md`, `external_validation/render_host_qualification_brief.md`, and `results/maniskill_render_host_qualification_brief_audit.md` preserve the current `DO_NOT_COLLECT_RENDER_MACHINE` state, cite official ManiSkill/SAPIEN/Vulkan source anchors, and define the independent GPU/Vulkan host proof needed before official collection can begin.
...
Independent validation launch ticket: `docs/independent_validation_launch_ticket.md`, `external_validation/independent_validation_launch_ticket.md`, and `results/independent_validation_launch_ticket_audit.md` turn the four strict external blockers into a copyable operator issue body with `DO_NOT_START_COLLECTION_YET`, `DO_NOT_COLLECT_RENDER_MACHINE`, Windows/Linux bootstrap and collection commands, upload expectations, close criteria, and an explicit non-Haonan proof route while remaining non-evidence.

Haonan/Yilun send-ready outreach: `docs/haonan_yilun_send_ready_outreach.md` and `results/haonan_yilun_send_ready_outreach_audit.md` provide the concise first-contact layer, with CoStream as the only first-email paper anchor, a 189-word email, the 17/21 STRONG_REVISE boundary, and an explicit rule that Haonan is not responsible for supplying the missing proof.
...
- Haonan/Yilun send-ready outreach: `docs/haonan_yilun_send_ready_outreach.md`
...
- Independent validation launch ticket: `docs/independent_validation_launch_ticket.md`
...
- ManiSkill render host qualification brief: `results/maniskill_render_host_qualification_brief_audit.md`
...
- Independent validation launch ticket: `external_validation/independent_validation_launch_ticket.md` and `results/independent_validation_launch_ticket_audit.md`
