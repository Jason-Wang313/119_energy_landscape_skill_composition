...
- ManiSkill render-video preflight: `results/maniskill_render_video_preflight_audit.md` exists, passes as non-evidence tooling, probes render-backed RGB MP4 export for the tracked public-simulator route with explicit render-backend/shader controls, and currently records render-video readiness as false on this local machine.
