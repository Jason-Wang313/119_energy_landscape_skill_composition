...
- `lock_code_skill_and_artifact_hashes` (release): fill code commit, skill-library hash, artifact hash policy, and the future manifest path; manifest-declared fidelity_acceptance_path is checked after postcollection sealing
