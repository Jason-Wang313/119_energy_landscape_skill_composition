...
- `README.md` (operator_facing_input, 25582 bytes, sha256 `1CFA8FB61B56C7C9F2CA0097D0D924BF1C2E447E540FE7CEB35D138F66CDDFC6`)
- `docs/haonan_yilun_outreach_package.md` (operator_facing_input, 12777 bytes, sha256 `C5097A6C2A6017E371A9F4FBDBA7A600EE0D2A544D4CA20E5ED76DD42AD0ACF8`)
...
- `docs/reproducibility_checklist.md` (operator_facing_input, 17857 bytes, sha256 `DEDF3B7295DEA1D19D9D8DDABDB7E875CE2BC7456C93AAED2C48D62796D07AC7`)
- `docs/submission_readiness_decision.md` (operator_facing_input, 16076 bytes, sha256 `94F3928BE30548D02E6496833E59FC7CCF0ED136DF986C6AD2FC23D98BAD259D`)
- `external_validation/README.md` (operator_facing_input, 32611 bytes, sha256 `69D397642420D776AC771C371BC233EC58297C96C6EF2F4F4DEA30F59641AC0D`)
...
- `external_validation/evidence_intake_ledger.csv` (operator_facing_input, 24251 bytes, sha256 `D3AC6811574F004B1E61C7F89507D9FC7B6DC235CC8F6152B9E6A259FB67FD19`)
- `external_validation/evidence_intake_ledger.json` (operator_facing_input, 39263 bytes, sha256 `37642ABD197BFB8F1002F5B7E0BC1A9B5560CADCD9A2A3F384D6C59A91B3BAC0`)
- `external_validation/evidence_intake_ledger.md` (operator_facing_input, 10141 bytes, sha256 `DBB96E0D48333D12C8E5BA92644247248C8F574B2CA6B2DD783D08A7A1B084C6`)
- `external_validation/fidelity_acceptance_draft.json` (operator_facing_input, 25786 bytes, sha256 `99B11266E8583BF9298DD6F408DFB5ED49284DCD057D1282FD0839EF357CE90A`)
- `external_validation/fidelity_acceptance_draft.md` (operator_facing_input, 6121 bytes, sha256 `33847FAA7C164FB56D5CFF7CAFEC728FFB26210DA16CE8665E76EABABEE70BB1`)
...
- `external_validation/manifest_precollection_draft.json` (operator_facing_input, 24646 bytes, sha256 `3823590EA93D742A39044821213EAD295E5C7014EF6F2B1A335F9AB20E6DCD67`)
...
- `external_validation/method_implementation_packet.json` (operator_facing_input, 81008 bytes, sha256 `D745F78A466A3E069ECFDB1272595AEA744CA6A4F1EFD45401196371E4F7E5FD`)
- `external_validation/method_implementation_packet.md` (operator_facing_input, 49752 bytes, sha256 `1152F00BAA03F1462BF8071E7B1F4AA5C8D7142D817492BACDF06294456F767B`)
- `external_validation/method_implementation_work_orders.csv` (operator_facing_input, 9836 bytes, sha256 `F0E1176FA9EF80BDCE8FA11648F9107C0675091272D5244F4D2C2B26E3156615`)
...
- `external_validation/render_machine_qualification_packet.md` (operator_facing_input, 4950 bytes, sha256 `DEC3361B1D11DB873CDC9979A0EB14197C20AB62F2746B43B1D8A7B2FCFB59B9`)
...
- `results/external_acquisition_packet.json` (generated_non_evidence_report, 48530 bytes, sha256 `8BF82468D212B5E042AA5655690A06AC045F9E7BDC49DE1DB82F2539DC2A8522`)
- `results/external_acquisition_packet.md` (generated_non_evidence_report, 30002 bytes, sha256 `151D6D24F7BEEBEB5C05B4ACA06A788CF180705AF5BF5873EFDE74D5B0DE8371`)
...
- `results/external_collection_readiness_audit.json` (generated_non_evidence_report, 7322 bytes, sha256 `E7588F12130745BCDCB8A824693C3E9AB3C33843BA2327453E1E1589CE3BB835`)
- `results/external_collection_readiness_audit.md` (generated_non_evidence_report, 3669 bytes, sha256 `B05E676720A426D71DFF1AED54D9CA864B494D26ACD43956496CA79AC02BEEE5`)
...
- `results/external_evidence_intake_ledger_audit.json` (generated_non_evidence_report, 39263 bytes, sha256 `37642ABD197BFB8F1002F5B7E0BC1A9B5560CADCD9A2A3F384D6C59A91B3BAC0`)
- `results/external_evidence_intake_ledger_audit.md` (generated_non_evidence_report, 10141 bytes, sha256 `DBB96E0D48333D12C8E5BA92644247248C8F574B2CA6B2DD783D08A7A1B084C6`)
...
- `results/external_execution_readiness_audit.json` (generated_non_evidence_report, 37432 bytes, sha256 `0DDA88AB70A867E02CAFCAF2E51509CC57440489FF2058CEF3524EEB8596EC9F`)
- `results/external_execution_readiness_audit.md` (generated_non_evidence_report, 29099 bytes, sha256 `717334931996E25AF8998F4D09CEAD18848FD5F6492BA1BA3F9D965C2ACA0B39`)
...
- `results/external_fidelity_acceptance_draft_audit.json` (generated_non_evidence_report, 6148 bytes, sha256 `C2005EE7863CC7D458293280FD725FF0300652D61FD74175CF4675B219FBD410`)
- `results/external_fidelity_acceptance_draft_audit.md` (generated_non_evidence_report, 5021 bytes, sha256 `36099CB1FD2C03B3551B7BA2504F4375226451C41BE7E9A041B8A84FBDAF41DD`)
...
- `results/external_method_implementation_audit.json` (generated_non_evidence_report, 5498 bytes, sha256 `FB06B42ECCB12E1B5B7EF0538C9A1F565D983C3D4A17F60FE6C4713B2A4BE2AD`)
- `results/external_method_implementation_audit.md` (generated_non_evidence_report, 4019 bytes, sha256 `13D39DA4B6B6A25FD652D107FF06B3C7E1B99322E6AB50FB5E81E67990456E4C`)
- `results/external_operator_packet.json` (generated_non_evidence_report, 48004 bytes, sha256 `4B0A980777BD19763D57E52445E9903BA22DF315B91299CEFA2F776204ADABFC`)
- `results/external_operator_packet.md` (generated_non_evidence_report, 22582 bytes, sha256 `5125AB57A2042AB0C193D4DEC2D92D42E5092AEC6F815F926AE48AB6A0C3818C`)
...
- `results/fidelity_acceptance_materialization_plan.json` (generated_non_evidence_report, 7920 bytes, sha256 `22E5559D08693D2BF4DD64FE63850654770F0C14FDAB7A122C4E4238F9808784`)
- `results/fidelity_acceptance_materialization_plan.md` (generated_non_evidence_report, 5882 bytes, sha256 `7D734E98E6C363ECCA905687DB745B7CA156E89AB2A2D32B75555214E61A5748`)
...
- `results/maniskill_pilot_runtime_liveness_audit.json` (generated_non_evidence_report, 6602 bytes, sha256 `777CA32E2EE37494FA69855ECFC5F1C03F7EAD11945519B0F76CFD1CE5521FDB`)
- `results/maniskill_pilot_runtime_liveness_audit.md` (generated_non_evidence_report, 4177 bytes, sha256 `03151AA95E39C92A0EFF788C87C2C22EE63BD4EBF38E5E63837F715BD67144A4`)
...
- `results/maniskill_render_machine_qualification.json` (generated_non_evidence_report, 5386 bytes, sha256 `4BF152A800CE2F7DCAF6404277B184E59A18792571D7814FA0F9F778D5D3F382`)
- `results/maniskill_render_machine_qualification.md` (generated_non_evidence_report, 4950 bytes, sha256 `DEC3361B1D11DB873CDC9979A0EB14197C20AB62F2746B43B1D8A7B2FCFB59B9`)
...
- `scripts/audit_external_collection_readiness.py` (operator_command_source, 20929 bytes, sha256 `DAF5D1CDC4EEE1DEE29AFAB7AB6406B011EECE72F2384098B906339BCB7B47C8`)
...
- `scripts/audit_maniskill_pilot_runtime_liveness.py` (operator_command_source, 25822 bytes, sha256 `BCA24AF818D770D00E3E10DBC3D36D71BC3C987966975294471BA2FF4964F108`)
...
- `scripts/build_external_acquisition_packet.py` (operator_command_source, 77622 bytes, sha256 `0C443B3D8A76054ADD5B029D882D453D06DD68503762F7059DA1DA6CF9CD6CF4`)
...
- `scripts/build_external_evidence_intake_ledger.py` (operator_command_source, 19041 bytes, sha256 `19814CB551C9734C785077201236F9E3A1D3B86E385295FE0A3DF2572B31BF17`)
...
- `scripts/build_external_method_implementation_packet.py` (operator_command_source, 45972 bytes, sha256 `B9137208560E4473D3CF09C3CF9D85DE849381FBD3635D350D555C313B06195C`)
- `scripts/build_external_operator_handoff_bundle.py` (operator_command_source, 58921 bytes, sha256 `C5C62B21A78CDA3D817572C70E0277312404795101EC32BA1166375C31C69581`)
- `scripts/build_external_operator_packet.py` (operator_command_source, 50253 bytes, sha256 `F7345BF6B4416BE27FA543BA40004D40F722B275EA5D3F394B65A6F016857664`)
...
- `scripts/build_maniskill_render_machine_qualification.py` (operator_command_source, 12858 bytes, sha256 `E3E6B2C1F1BC596820263A723701D0E1B65A49FECA3EAC1F2F29828558C5A038`)
...
- `scripts/validate_external_adapters.py` (operator_command_source, 27781 bytes, sha256 `02E66E5DB73E1DED16F2CC3D0C9659228243D1C2447AA34B6AE2E4AE9F8B7BDC`)
...
- `pass` `handoff_has_task_config_and_baseline_assets`: category_counts={'baseline_spec': 12, 'config_template': 4, 'generated_non_evidence_report': 88, 'operator_command_source': 38, 'operator_facing_input': 66, 'prepared_config_input': 4, 'reference_adapter': 60, 'runner_backend_template': 5, 'task_card': 4}
...
- `pass` `maniskill_pilot_runtime_liveness_included`: pilot_runtime_ready=False, runner_io_ready=False, render_video_ready=False, timed_out=True, records=0, videos=0, diagnostic_fallbacks=0, failure_summary='runner timed out after progress stage reset_scene_start before producing the required pilot record/video'
...
- `pass` `file_hashes_are_recorded`: hashed_files=281
