...
- `pass` `abstract_exists`: words=241
- `pass` `abstract_length_conference_reasonable`: words=241
- `pass` `required_sections_present`: positions=[2256, 5863, 9137, 10987, 11861, 13395, 21143, 25030]
- `pass` `required_sections_in_order`: positions=[2256, 5863, 9137, 10987, 11861, 13395, 21143, 25030]
...
- `pass` `world_action_framing_not_overdone`: count=6
