...
- `pass` `maniskill_pilot_runtime_liveness_visible`: pilot_runtime_ready=False, runner_io_ready=False, render_video_ready=False, render_backend='cpu', shader_pack='minimal', timed_out=True, records=0, videos=0, diagnostic_fallbacks=0, diagnostic_rejected=False, last_stage='reset_scene_start', failure_summary='runner timed out after progress stage reset_scene_start before producing the required pilot record/video'
