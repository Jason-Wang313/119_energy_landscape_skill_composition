...
- `pass` `partial_batch_failure_preserves_official_jsonl`: returncode=1, log_preserved=True, output=Traceback (most recent call last): File "C:\Users\wangz\robotics_massive_pool_paper_factory\119_energy_landscape_skill_composition\external_validation\runner\real_collection_runner.py", line 684, in <module> raise SystemExit(main())
