...
Prepared task configs bound: `true`.
Tracked candidate method configs bound: `true`.
...
- `pass` `prepared_task_configs_bound_in_full_pipeline_fixture`: tasks=4, prepared_tasks=4
- `pass` `tracked_candidate_method_configs_bound_in_full_pipeline_fixture`: methods=12, tracked_non_oracle_methods=11
...
- `pass` `tampered_release_artifact_hash_rejected`: release_code_failure="entries=11, malformed=[], missing_paths=[], missing_sha256=[], hash_mismatches=['external_validation/implementations/greedy_module_sequence/adapter.py: declared=000000000000..., actual=473FF337E5E0...'], hash_errors=[]"
