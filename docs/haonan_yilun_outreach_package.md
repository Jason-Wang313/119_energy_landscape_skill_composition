...
- Use the independent operator packet, External ablation collection packet, reference-adapter provenance catalog, strict reference-adapter rejection gate, and manifest assembly checklist as Jason-owned validation scaffolding; do not frame Haonan as responsible for supplying the missing proof.
