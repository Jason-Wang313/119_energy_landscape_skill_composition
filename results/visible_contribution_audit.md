...
- `pass` `operator_handoff_bundle_visible`: files=387, forbidden=[], start_state='DO_NOT_COLLECT_YET'
...
- `pass` `external_operator_release_bundle_visible`: bundle_state='READY_TO_SEND_OPERATOR_PACKAGE', files=387, archive_written=False
