...
- The external method implementation packet turns the missing non-oracle baseline layer into concrete per-method work orders, a reference-adapter provenance catalog, a strict reference-adapter rejection gate, a strict independent method provenance gate, and a strict checkpoint/config artifact gate while strict adapter evidence remains missing.
