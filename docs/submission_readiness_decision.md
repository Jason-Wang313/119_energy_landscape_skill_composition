...
- The render/pilot progress markers now record the last completed renderer or collection stage before a local ManiSkill preflight failure, so the independent operator can distinguish import, render, MP4-writing, and official-video-guard blockers without treating the probe as evidence.
