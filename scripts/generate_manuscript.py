...
def make_manuscript(summary):
    ...
    a(r"\usepackage{colortbl}")
    a(r"\definecolor{PaperLinkBlue}{HTML}{1F5FBF}")
    a(r"\definecolor{TableHeader}{HTML}{E8F0F8}")
    a(r"\definecolor{TableBand}{HTML}{F7FAFC}")
    a(r"\definecolor{TableProposed}{HTML}{EAF6EF}")
    a(r"\definecolor{TableBaseline}{HTML}{FFF4DE}")
    a(r"\definecolor{TableOracle}{HTML}{EEF1F6}")
    a(r"\definecolor{TableRule}{HTML}{A9BDD1}")
    a(r"\definecolor{TableGreen}{HTML}{257A4E}")
    a(r"\definecolor{TableRed}{HTML}{A33A3A}")
    ...
    a(r"\hypersetup{colorlinks=true,linkcolor=PaperLinkBlue,citecolor=PaperLinkBlue,urlcolor=PaperLinkBlue}")
    a(r"\setlist[itemize]{leftmargin=1.2em,itemsep=0.15em,topsep=0.2em}")
    a(r"\setlength{\textfloatsep}{0.45em plus 0.1em minus 0.2em}")
    a(r"\setlength{\floatsep}{0.45em plus 0.1em minus 0.2em}")
    a(r"\setlength{\intextsep}{0.45em plus 0.1em minus 0.2em}")
    a(r"\raggedbottom")
    ...
    a(r"\begin{table}[t]\centering\footnotesize\resizebox{0.92\linewidth}{!}{\input{generated_gate_table.tex}}\caption{Local evidence gates used for the seam-composition audit. External robot or high-fidelity validation is evaluated separately.}\label{tab:gates}\end{table}")
    ...
    a(r"\begin{table}[t]\centering\scriptsize\resizebox{\linewidth}{!}{\input{generated_main_table.tex}}\caption{Hard-slice aggregate results. Higher success, utility, basin, and descent are better; lower seam, barrier, damage, cost, and breach are better.}\label{tab:main}\end{table}")
    a(r"\begin{table}[t]\centering\footnotesize\resizebox{0.96\linewidth}{!}{\input{generated_pairwise_table.tex}}\caption{Paired proposed-minus-baseline hard-slice differences.}\label{tab:pairwise}\end{table}")
    ...
    a(r"\begin{figure}[t]\centering\includegraphics[width=0.94\linewidth]{../figures/energy_landscape_composition_ablation_v5.pdf}\caption{Removing v5 energy-seam components weakens the composer.}\label{fig:ablation}\end{figure}")
    a(r"\begin{figure}[t]\centering\includegraphics[width=0.80\linewidth]{../figures/energy_landscape_composition_stress_sweep_v5.pdf}\caption{Stress sweep over seam discontinuity and hidden barriers.}\label{fig:stress}\end{figure}")
