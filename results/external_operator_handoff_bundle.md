...
- `baseline_spec`: `12`
- `config_template`: `4`
- `generated_non_evidence_report`: `68`
- `operator_command_source`: `28`
- `operator_facing_input`: `50`
...
- `README.md` (operator_facing_input, 14974 bytes, sha256 `095CAD1F722763DF80DE224953480E69660388DD1F50CE13C48B61044B5364C2`)
- `docs/haonan_yilun_outreach_package.md` (operator_facing_input, 10521 bytes, sha256 `DC7891F57B1D3A42AA1BACFB02AE0D02469EC76DE60D63DC2A9C86469EF57697`)
...
- `docs/reproducibility_checklist.md` (operator_facing_input, 15092 bytes, sha256 `624713DD0B7A6569740FBE7E901A2641CDC28193FAEFB2AAE7784B5EBF650358`)
- `docs/submission_readiness_decision.md` (operator_facing_input, 6332 bytes, sha256 `A9C74DB98E9577E1892111D58EDBDC50CF639E364E174C12F033E66730F7AD23`)
- `external_validation/README.md` (operator_facing_input, 28622 bytes, sha256 `7B4523D8EF689DA8085378EA21DDD294AC94DD364C052FBAFF7561F47CC366E6`)
...
- `external_validation/platform_onboarding_packet.json` (operator_facing_input, 11887 bytes, sha256 `370FB794B7925AE8D3126070E0CB223428C9BBEA0CBFD3D1785EF765E5821165`)
- `external_validation/platform_onboarding_packet.md` (operator_facing_input, 9300 bytes, sha256 `E43FC990A949CF90D9DAE90A6A8116AF6F22131C26771E77B508BC4F66D5AF91`)
...
- `results/external_acquisition_packet.json` (generated_non_evidence_report, 29517 bytes, sha256 `9A537CED46B47B620331E981C9E69DA0F37694A87E45F00E18B4A3D7F31BE2A2`)
- `results/external_acquisition_packet.md` (generated_non_evidence_report, 19527 bytes, sha256 `8524170F25E8669BCE78B65E876AA0EA80AC53B4504B33D898DA9140EA9A08D1`)
...
- `results/external_execution_readiness_audit.json` (generated_non_evidence_report, 29222 bytes, sha256 `3813A5BC98526AECF4130D30597E2CE59D8B5CD27024091940298ABCBA1AF1A7`)
- `results/external_execution_readiness_audit.md` (generated_non_evidence_report, 22338 bytes, sha256 `46959D056EAA5CE6C89F32041E64B7B791FD702B6B2AC07098736EE417CA0704`)
...
- `results/external_operator_packet.json` (generated_non_evidence_report, 23461 bytes, sha256 `2A3F73C24BB943F5F97F5A8C1DFC7AF7D4C98E3705B53786EA78F09AC897C556`)
- `results/external_operator_packet.md` (generated_non_evidence_report, 6174 bytes, sha256 `8EE88E39A3F5CFD9136C23F1C9393ACCB1502ED0AFA3C42CD14960BDE8695770`)
...
- `results/external_platform_onboarding_audit.json` (generated_non_evidence_report, 7531 bytes, sha256 `E900865916002854D47713B860F2E05040599216589AEC14844FFCDCD011FD7D`)
- `results/external_platform_onboarding_audit.md` (generated_non_evidence_report, 5780 bytes, sha256 `737F185BEA41D8DAC1AEF01B5E6B184C579FC40EE08D5F501C08805163813AF7`)
- `results/external_platform_probe.json` (generated_non_evidence_report, 11698 bytes, sha256 `9CD0A7F716D52AEE6B83588087AC52F02B7E9C52CE94C519D6344563DB0B964D`)
- `results/external_platform_probe.md` (generated_non_evidence_report, 2287 bytes, sha256 `792CDBB27A7950FA348756E865774A052A62F6E09FF40A812D5475FB4AC78587`)
...
- `results/maniskill_env_smoke_probe.json` (generated_non_evidence_report, 12601 bytes, sha256 `1FA6007E58388FC99D805AAFE6ED0878CD5275C21792055901406D1A7EB282FF`)
- `results/maniskill_env_smoke_probe.md` (generated_non_evidence_report, 1835 bytes, sha256 `1CF89D3373685C11B71F4A8DD4B7E5DFCE7C6DB3A90B21CB77675B7B5C869E23`)
...
- `scripts/build_external_acquisition_packet.py` (operator_command_source, 47658 bytes, sha256 `ECDB29A968A3C83FBCEE2FDCC1556BC87AE2CD7A4F9DB7BFB5E7DF04A6FEBFDD`)
...
- `scripts/build_external_operator_handoff_bundle.py` (operator_command_source, 39468 bytes, sha256 `F96BCE86C51018A29B80AEB779E092F09A0287C18B9E3D51F13D9A163680D1CD`)
- `scripts/build_external_operator_packet.py` (operator_command_source, 12773 bytes, sha256 `F9B6ACD8DD4DFBB45F7ECCEDBB097540928634D46C3A7A93DBD0E4CAD775A6AD`)
...
- `scripts/build_external_platform_onboarding.py` (operator_command_source, 30014 bytes, sha256 `16619991CFFFEF1C4323C2360A48189A07ABB0740F23B4CCEE7DB8F64B1DAB99`)
...
- `scripts/probe_maniskill_env_smoke.py` (operator_command_source, 16037 bytes, sha256 `94AC6219AA764261FFC6314982C42B7738799653F9A93F51EA95FEDED54E07AA`)
...
- `pass` `handoff_has_task_config_and_baseline_assets`: category_counts={'baseline_spec': 12, 'config_template': 4, 'generated_non_evidence_report': 68, 'operator_command_source': 28, 'operator_facing_input': 50, 'prepared_config_input': 4, 'reference_adapter': 60, 'runner_backend_template': 5, 'task_card': 4}
...
- `pass` `file_hashes_are_recorded`: hashed_files=235
