...
- `pass` `temporary_fixture_builds_current_release_plan`: status=0, files=342, archive=False
- `pass` `explicit_archive_fixture_writes_deterministic_transfer_zip`: status=0, entries=344, sha='F0B4CC3CEE13CF163780469151BA57532FAEE2A8B4C827472ABE17EB12E4ABB0'
