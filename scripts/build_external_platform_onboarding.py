...
def build_packet(
    ...
    return {
        ...
        "pilot_sequence": [
            ...
            "Seal the collected logs/videos, run the seal-consistency audit, then build the manifest and run strict rollout, pairing, release-package, and evidence audits from raw logs.",
        ],
