...
|---|---|
| `Independent real-robot or accepted high-fidelity external validation evidence` | `platform_probe`, `task_binding_probe`, `env_smoke_probe`, `platform_onboarding`, `fidelity_provenance_packet`, `backend_integration_packet`, `rollout_evidence_packet`, `backend_module`, `platform_fidelity`, `pilot_smoke_packet`, `run_collection`, `manifest_and_release` |
