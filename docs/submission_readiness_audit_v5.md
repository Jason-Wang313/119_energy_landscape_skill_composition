...
- External collection runbook: `external_validation/collection_runbook.md`, `external_validation/operator_record_sheet.csv`, task cards, config templates, and `results/external_runbook_audit.md` exist, pass, remain non-evidence collection scaffolding, and now expose 41 validation commands with the current ManiSkill route gates and actual high-fidelity collection command template ordered before strict evidence gates.
