...
- `pass` `external_method_implementation_covers_missing_methods`: method_checks={'packet_is_non_evidence_and_fail_closed': True, 'work_orders_cover_all_missing_non_oracle_methods': True, 'oracle_excluded_from_work_orders': True, 'spec_files_cover_work_orders': True, 'required_artifact_fields_declared': True, 'required_log_fields_declared': True, 'manifest_entry_templates_cover_required_hash_fields': True, 'manifest_entry_templates_bind_hash_to_checkpoint_config_artifact': True, 'manifest_entry_templates_require_independent_provenance': True, 'manifest_entry_templates_bind_fairness_contract': True, 'work_orders_forbid_scaffolds_and_reference_adapters': True, 'policy_or_config_hash_in_logs_required': True, 'adapter_acceptance_fixtures_cover_non_oracle_methods': True, 'adapter_acceptance_fixtures_define_contract': True, 'work_orders_reference_acceptance_fixtures': True, 'reference_adapter_provenance_covers_non_oracle_methods': True, 'reference_adapter_hashes_recorded': True, 'reference_adapters_marked_non_evidence': True, 'reference_manifest_stubs_not_strict_ready': True, 'common_reference_adapter_hash_shared': True, 'reference_policy_hashes_match_adapter_formula': True, 'method_manifest_cutover_checklist_covers_non_oracle_methods': True, 'method_manifest_cutover_checklist_binds_manifest_fields': True, 'method_manifest_cutover_checklist_forbids_shortcuts': True, 'strict_commands_cover_adapter_rollout_pairing_and_evidence': True, 'adapter_evidence_still_missing': True, 'no_real_implementation_files_created': True, 'packet_files_written': True}
- `pass` `external_method_implementation_gate_order`: method packet, work orders, adapter fixtures, manifest cutover checklist, reference provenance, builder, and strict command order are present
- `pass` `fidelity_acceptance_contract_ready`: passed
- `pass` `fidelity_acceptance_not_evidence`: not_external_evidence=True
- `pass` `fidelity_acceptance_fail_closed`: acceptance_ready=False, readiness_state='COLLECT_PLATFORM_PROVENANCE', blocking_missing_count=17
...
- `pass` `external_fidelity_provenance_covers_acceptance_blocker`: checks={'packet_is_non_evidence_and_fail_closed': True, 'fidelity_acceptance_contract_ready_but_not_evidence': True, 'platform_onboarding_packet_ready': True, 'external_platform_probe_ready': True, 'independent_route_and_collection_still_fail_closed': True, 'template_declares_required_platform_and_gate_fields': True, 'work_orders_cover_fidelity_blockers': True, 'work_orders_are_actionable_and_artifact_bound': True, 'strict_commands_cover_fidelity_manifest_collection_and_evidence': True, 'acceptance_template_not_real_evidence': True, 'no_real_acceptance_or_manifest_written': True, 'packet_files_written': True}
- `pass` `external_fidelity_provenance_gate_order`: checks={'packet_is_non_evidence_and_fail_closed': True, 'fidelity_acceptance_contract_ready_but_not_evidence': True, 'platform_onboarding_packet_ready': True, 'external_platform_probe_ready': True, 'independent_route_and_collection_still_fail_closed': True, 'template_declares_required_platform_and_gate_fields': True, 'work_orders_cover_fidelity_blockers': True, 'work_orders_are_actionable_and_artifact_bound': True, 'strict_commands_cover_fidelity_manifest_collection_and_evidence': True, 'acceptance_template_not_real_evidence': True, 'no_real_acceptance_or_manifest_written': True, 'packet_files_written': True}
- `pass` `external_fidelity_provenance_self_test_ready`: passed
- `pass` `external_fidelity_provenance_self_test_guards`: checks={'temporary_fidelity_provenance_packet_ready_but_non_evidence': True, 'missing_work_orders_rejected': True, 'work_order_artifact_command_drift_rejected': True, 'premature_evidence_promotion_rejected': True, 'acceptance_ready_drift_rejected': True, 'onboarding_strict_evidence_drift_rejected': True, 'platform_probe_promotion_rejected': True, 'collection_ready_promotion_rejected': True, 'template_gate_shrink_rejected': True, 'strict_command_drift_rejected': True, 'real_acceptance_or_manifest_write_rejected': True, 'packet_file_deletion_rejected': True, 'real_fidelity_provenance_outputs_untouched': True}
...
- `pass` `fidelity_acceptance_materializer_guarded`: command='python scripts\\materialize_fidelity_acceptance.py --operator-name-or-lab <independent_operator_or_lab> --accepted-collection-machine <machine_or_robot_platform> --contact-solver-and-friction-model <solver_friction_contact_model> --timestep-and-substeps-per-control-step <sim_dt_control_dt_substeps> --paired-reset-replay-test <paired_reset_replay_result> --real-or-benchmark-calibration-basis <calibration_basis> --task-binding-decision <accepted_or_replaced_task_bindings> --acceptance-gate-signoff <gate_signoff_summary> --known-limitations <known_limitations> --date-locked <YYYY-MM-DD> --code-commit <current_clean_checkout_commit_sha> --skill-library-hash <current_baselines_sha256> --confirm-real-platform --confirm-independent-operator --confirm-render-backed-videos --write', commit='d9d7a93d829effca0338e739edafa7b3e21d0d03', skill_hash='62EA64D1C80D67F5EB7EC63A88A581AE2D89B4230873F11D46799658541411F1', clean=False, dirty_count=21
- `pass` `fidelity_acceptance_materializer_self_test_ready`: passed, not_external_evidence=True
- `pass` `fidelity_acceptance_materializer_self_test_guards`: checks={'matching_clean_checkout_writes_temp_acceptance': True, 'stale_commit_rejected_without_temp_write': True, 'mismatched_skill_hash_rejected_without_temp_write': True, 'dirty_checkout_rejected_without_temp_write': True, 'pycache_excluded_from_skill_library_hash': True, 'real_acceptance_file_not_touched': True}
...
- `pass` `maniskill_render_resource_sweep_ready`: passed
- `pass` `maniskill_render_resource_sweep_not_evidence`: any_ready=False, records=3, classes=['vulkan_descriptor_pool_exhaustion']
...
- `pass` `external_backend_integration_covers_backend_blocker`: backend_integration_checks={'packet_is_non_evidence_and_fail_closed': True, 'primary_route_matches_onboarding': True, 'backend_contract_harness_ready_but_backend_missing': True, 'work_orders_cover_backend_to_manifest_path': True, 'work_orders_are_actionable_and_artifact_bound': True, 'required_hooks_declared': True, 'provenance_fields_declared': True, 'tasks_and_record_budget_preserved': True, 'strict_commands_cover_backend_config_fidelity_collection_and_evidence': True, 'collection_readiness_still_blocks_backend': True, 'no_real_backend_files_created': True, 'packet_files_written': True}
- `pass` `external_backend_integration_gate_order`: backend packet, work orders, builder, and strict command order are present
- `pass` `external_backend_integration_self_test_ready`: passed
- `pass` `external_backend_integration_self_test_guards`: checks={'temporary_backend_integration_packet_ready_but_non_evidence': True, 'missing_work_orders_rejected': True, 'work_order_artifact_command_drift_rejected': True, 'premature_backend_evidence_promotion_rejected': True, 'route_independence_drift_rejected': True, 'actual_backend_promotion_rejected': True, 'hook_contract_drift_rejected': True, 'provenance_field_drift_rejected': True, 'task_budget_shrink_rejected': True, 'strict_command_drift_rejected': True, 'collection_ready_promotion_rejected': True, 'real_backend_file_write_rejected': True, 'packet_file_deletion_rejected': True, 'real_backend_integration_outputs_untouched': True}
...
- `pass` `external_ablation_collection_packet_ready`: passed
- `pass` `external_ablation_collection_packet_self_test_ready`: passed
...
- `pass` `external_precollection_manifest_draft_ready`: passed
- `pass` `external_precollection_manifest_draft_self_test_ready`: passed
- `pass` `external_precollection_manifest_draft_not_evidence`: draft_ready=True, strict_external_evidence_ready=False, official_manifest_exists=False
- `pass` `external_precollection_manifest_draft_config_hashes`: prepared_config_count=4
- `pass` `external_precollection_manifest_draft_fail_closed`: method_gaps=11, rollout_gaps=8
- `pass` `external_precollection_manifest_draft_self_test_mutations`: temporary_draft_ready=True, candidate_hash_drift=True, source_drift=True
...
- `pass` `external_postcollection_evidence_seal_gate_order`: commands=12
- `pass` `external_postcollection_seal_consistency_gate_ready`: passed
- `pass` `external_postcollection_seal_consistency_not_evidence`: seal_consistency_ready=False, ready_for_manifest_promotion=False
- `pass` `external_postcollection_seal_consistency_hash_recompute`: matched=11, records=0, videos=0
- `pass` `external_postcollection_seal_consistency_gate_order`: commands=12
...
- `pass` `external_operator_handoff_bundle_hash_manifest`: included_file_count=375, category_counts={'baseline_spec': 12, 'config_template': 4, 'generated_non_evidence_report': 128, 'method_config_candidate': 11, 'operator_command_source': 59, 'operator_facing_input': 88, 'prepared_config_input': 4, 'reference_adapter': 60, 'runner_backend_template': 5, 'task_card': 4}
